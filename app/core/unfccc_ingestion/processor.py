...
from app.core.unfccc_ingestion.collection import handle_collection_from_row
from app.core.unfccc_ingestion.family import handle_family_from_row
...
def get_dfc_ingestor(db: Session) -> ProcessFunc:
    ...
    def process(context: IngestContext, row: UNFCCCDocumentIngestRow) -> None:
