...
tags = {
    ...
    "CPR-Tag": f"{environment}-document-store",
...
pulumi.export("document_store_cluster_name", aurora_cluster._name)
pulumi.export(
    "document_store_instance_ids",
    [instance.id for instance in aurora_instances],
)
pulumi.export("endpoint", aurora_cluster.endpoint)
pulumi.export("reader_endpoint", aurora_cluster.reader_endpoint)
