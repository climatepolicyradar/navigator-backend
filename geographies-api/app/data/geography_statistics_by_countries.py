...
geography_statistics_by_countries = {
    ...
    "TUR": {
        "name": "Turkey",
        "legislative_process": "Turkey is a republic based on democracy, secularism, social state, rule of and fundamental rights and freedoms. Legislative power is vested in the Grand National Assembly (GNAT), a unicameral parliament with 600 deputies elected for four-year terms. GNAT’s election system is based on proportional representation determined by the “D’Hondt formula”, a mathematical formula which involves the principle of highest average. A political party must have at least 10% of total votes to win seats in Parliament. Last general election was held in June 2018. The Assembly is responsible for the enactment, amendment and repeal of laws. The laws adopted by the Assembly are promulgated by the President within 15 days or referred back to the Assembly for further consideration.<br><br></div><div>The right to introduce bills belongs to the deputies and to the government. The bills introduced by deputies are described as private members’ bills. The Council of Ministers was abolished by the 2017 constitutional amendments, so the executive power is not dualist anymore. The Speaker of the Assembly designates the bill to be considered by a designated standing committee with relevant expertise, which issues a formal opinion to the Assembly before it is put to vote.<br><br></div><div>Once passed by the Assembly, the law is then transferred to the President. Then the law is sent to the Prime Ministry to be published in the Official Gazette according to the will of the President. Once published, the law takes immediate effect unless otherwise provided in the law. With the exception of budget bills the President may veto all or a portion of a bill, sending the legislation back to the Assembly for re-consideration with justification.<br><br></div><div>If the President does not approve the publication of the bill in part, the Assembly may debate only the articles that are not approved or the bill as a whole. The Assembly may adopt the text with or without amendments after this debate. If the Assembly accepts the law without amendment, the President must approve promulgation in the Official Gazette. If the Assembly accepts the law with amendments, the President has the right to send the law back to the Assembly.",
        "federal": False,
        "federal_details": "",
    ...
    "ARE": {
        ...
        "legislative_process": "<br>The United Arab Emirates was established in 1971 as a federation of seven emirates – Dubai, Abu Dhabi, Ajman, Fujairah, Ras Al Khaimah, Sharjah and Umm Al Quwain. They are governed by a Federal Constitution, which was made permanent in 1996.<br><br></div><div>The Federal Government structure comprises five bodies: the Federal Supreme Council, President, Council of Ministers, Federal National Council and Federal Judiciary.<br><br></div><div>The Federal Supreme Council (FSC), composed of the rulers of the seven emirates, is the highest legislative, executive, and constitutional authority in the land – it elects the President and the Vice-President, approves nomination of the Prime Minister, and ratifies federal laws and decrees. The Federal National Council, with forty members out of which half are elected for four-year term, serves in an advisory capacity. The last election was held in October 2015 and the next is expected for 2019.<br><br></div><div>The President has a wide range of legislative and executive powers, including signing laws, decrees and decisions approved and sanctioned by the Supreme Council, supervising their implementation through the Council of Ministers, and ratifying treaties and international agreements approved by the Supreme Council and Council of Ministers. The ruler of each emirate also has extensive, near-sovereign regulatory powers within the emirate.<br><br>",
        "federal": True,
    ...
    "ECU": {
        "name": "Ecuador",
        "legislative_process": "Ecuador was the first Latin American country to successfully move from military rule to a multi-party decentralised democracy based on the rule of law, following a referendum in 1978. However the Republic has endured recurrent periods of political instability during the past decade that have eroded the strength of the state, and weakened the public sector. Historically there has been little co-operation between political parties and the political instability is reflected in the fact that few recent leaders have finished their term in office: there were seven Presidents between 1996 and 2007.<br><br></div><div>These factors contributed to Ecuador’s constitution being rewritten in 2008, the country’s 20th such change. In 2009 the unicameral 137-seat National Assembly was created, which replaced the Legislative Commission. Assembly members were elected in 2021 by popular vote for a four-year term on a party list mostly-proportional representation system. The new constitution also allows the president and vice-president to be elected for four-year terms. The president in turn appoints a 38-member cabinet. These changes appear to have heralded a new period of political stability, with the incumbent President being re-elected in early 2013.<br><br>Ecuador’s Constitution is “the supreme law of the land and prevails over any other legal regulatory framework. The standards and acts of public power must be upheld in conformity with the provisions of the Constitution; otherwise, they shall not be legally binding” (Article 424). The body in charge of controlling, constitutionally interpreting and administering justice is the Constitutional Court, which enjoys administrative and financial autonomy.&nbsp;<br><br></div><div>In the judiciary, the National Court of Justice is elected by an independent body of professionals, the Judiciary Council. Judges are elected for nine years. Candidates for the Constitutional Court are selected by the president, government officials and the Supreme Court, with the judges finally appointed by the National Assembly for two-year terms.",
        "federal": False,
        "federal_details": "",
        "political_groups": "G77",
        "global_emissions_percent": "0.2",
    ...
    "MEX": {
        "name": "Mexico",
        "legislative_process": "<p>The United Mexican States (Mexico) has a bicameral legislature (Congress) made up of the Chamber of Deputies and the Senate. The Lower Chamber is formed by 300 members elected in a system of electoral districts, and 200 members elected through a system of regional lists for a three-year term. The Senate has 128 senators, two of whom are elected and one assigned for each of the 31 states and the Federal District for a six-year term. The last elections for the Senate as well as the Chamber of Deputies occurred on July 1st, 2018.</p><p>The Constitution establishes that&nbsp; the President and members of the Congress can introduce a bill in Congress. In accordance with Art. 71 of the Constitution, citizens also have the ability to introduce bills if they can gather at least 0.13% of the electorate. In practice, most bills are initiated by the executive branch. With a few exceptions, the legislative process requires the discussion and approval of a draft bill by both the Senate and the Chamber of Deputies. The Senate addresses all matters concerning foreign policy, approves international agree¬ments and confirms presidential appointments. The Chamber of Deputies addresses all matters pertaining to the government’s budget and public expenditures.</p><p>If passed in both Chambers, a bill becomes law once it has received presidential approval and been published in the official gazette. If not sanctioned, the bill is sent back to one of the chambers with suggested amendments, re-launching the legislative process for the adoption of that law.</p>",
        "federal": True,
    ...
    "PER": {
        "name": "Peru",
        "legislative_process": "Peru is a presidential republic made up of 25 administrative regions. The federal legislature is a unicameral congress, composed of 130 representatives who are elected by popular vote for five-year terms. The last election was held in April 2016, the next one is expected for 2021. National legislation can be proposed by the following: the executive branch (the President, elected by popular vote for a five-year term, the Prime Minister, appointed by the President, and the Council of ministers, also appointed by the President), members of Congress, the Judiciary, autonomous public bodies, municipalities or professional associations. Citizen groups and individuals are also constitutionally guaranteed the right to submit legislation to Congress for consideration.</div><div>When Congress passes a bill, the President may sign it into law within 15 days, or send it back to Congress for further review. Once promulgated by the President, the legislation is enacted and in force on the date of publication in the official congressional gazette, <em>El Peruano</em>.</div><div>Laws passed by Congress and signed by the President represent the strongest form of legislation. Supplemental legislation exists by the way of legislative resolutions, which are employed to ratify international treaties or specify and modify rules and regulations of existing legislation. Likewise the executive branch may issue a “supreme decree” (executive decree), which does not need congressional approval but does require the signature of at least one sitting cabinet minister. Much of the current legislation specific to climate change is in the form of executive decrees.</div><div>In 2002, the Congress passed the Decentralisation Framework Law, which decentralises fiscal planning from the central government to the 25 regional administrative governments, composed of a Regional President and a Council (both President and Council Members are elected for four-year terms), advised by specialised Co-ordinating Councils. Regional administrations are also responsible for implementation of federal laws.",
        "federal": False,
        "federal_details": "",
        "political_groups": "G77",
    ...
    "IDN": {
        "name": "Indonesia",
        "legislative_process": '<p style="text-align: justify;">The Indonesian legal system is based on Roman-Dutch law, custom and Islamic law. The legislature is bicameral and comprises the 560 member House of People’s Representatives (DPR) and the 136 member House of Regional Representatives (DPD). The ensemble of DPR and DPD members forms a third representative body known as the People’s Con­sultative Assembly (MPR). The DPR and the President jointly discuss and approve every Bill. Bills may come from the DPR, the President or the DPD. A wide range of legislation is produced from different sources and with different levels of authority, so there is a hierarchy of legislation, as follows: the 1945 Constitution; MPR Resolution; Law; Government Regulation Substituting a Law; Government Regulation; Presidential Decree; Regional Regulation. Also binding are Presidential Instructions, Ministerial Decrees and Circular Letters.</p>\n<p style="text-align: justify;">The most recent elections for the DPR and DPD were held in April 2014, with the next expected in 2019. The current President was elected in October 2014 and serves a five-year term.</p>',
        "federal": False,
        "federal_details": "",
        "political_groups": "G77;G20",
    ...
    "NZL": {
        "name": "New Zealand",
        "legislative_process": '<br>New Zealand’s parliamentary system is unicameral – it has only one chamber (House of Representatives) and there is no upper house. The members of the House of Representatives serve a term of three years and are elected using the mixed member proportional representation voting system, whereby each citizen of voting age gets two votes. The first is for a local Member of Parliament, the second for a political party. Typically, the House of Representatives has 120 members. However, this can vary because the representation of political parties is proportional to the number of votes they receive in the general elections. The most recent general election was in September 2014, with the next general election needing to be held before the end of November 2017.<br><br></div><div><br>Proposed laws are called bills and are introduced to the House of Representatives. The legislative process begins with a first reading in the House of Representatives. The bill is debated and a decision is reached on whether it progresses to the next stage or not. If a bill passes the first reading, it is usually referred to a select committee to be considered in more detail. In a second reading, the bill and any changes recommended by the select committee are again considered by the House. If successful, all the changes made are worked into the bill before it is considered for a final reading, typically in the form of a summing-up debate. The bill is then put to a vote to either pass or reject it. A bill does not become an Act of Parliament until it is signed by the Sovereign of New Zealand or his/her representative (the Governor-General). This is called the Royal Assent.<br><br></div><div><br>New Zealand is a <a href="http://en.wikipedia.org/wiki/Unitary_state">unitary state</a> rather than a <a href="http://en.wikipedia.org/wiki/Federation">federation</a>. Local governments in New Zealand play no role in the legislative process other than by making submissions on bills.<br><br>',
        "federal": False,
        "federal_details": "",
        "political_groups": "OECD",
        "global_emissions_percent": "0.15",
    ...
    "VNM": {
        "name": "Vietnam",
        "legislative_process": "Vietnam is a highly centralised state, whose constitution provides the fundamental and highest law. The majority of power resides at this central level with all laws and policies issued by the National Assembly and the government. The former produces framework legislation, while the latter provides guidance on the implementation of legislation.<br><br></div><div>The National Assembly is a unicameral body elected for a five-year term, which elects a president as head of state, and a prime minister as head of government. The assembly is Vietnam’s legislative body, and the highest level representa­tive body. It is responsible for approving and supervising the implementation of state plans. The Communist Party has decisive influence over the executive and exercises control through the Central Committee. Members of the party hold all senior government positions. Legislative elections were held in 2021.<br><br>The current Constitution of the Socialist Republic of Vietnam was passed in 1992; it has since had two amends in 2001 and 2013. Vietnam is a socialist republic with the Vietnamese Communist Party as the sole source of leadership for the State and society. The legislative branch is exercised by the National Assembly, a 498-member unicameral body elected to a five-year term and is recognized as “the highest organ of state power”. The National Assembly further decides significant national affairs and has control over all activities of the State (article 69), including making and amending the Constitution (article 70), and naming the President and cabinet, the Prime Minister and the President of the Supreme People’s Court. Furthermore, the National Assembly holds the power of control of conformity over the Constitution and abrogating decisions from the Supreme People’s Court — the highest court for appeal and review (article 104) —.&nbsp;",
        "federal": False,
        "federal_details": "",
        "political_groups": "G77",
        "global_emissions_percent": "0.88",
