...
def upgrade():
    ...
    op.add_column('physical_document_language', sa.Column('source', language_source, nullable=False))
    op.add_column('physical_document_language', sa.Column('visible', sa.Boolean(), nullable=False))
