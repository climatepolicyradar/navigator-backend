...
EXPECTED_RDS_DOCUMENTS = [
    {
        "document_id": 5, "import_id": "CCLW.executive.10992.6270",
        ...
        "publication_ts": "2021-01-01T00:00:00"},
    {
        ...
        "name": "National REDD+ Investment Plan (PNI-REDD+)", "postfix": "",
        ...
        "publication_ts": "2020-01-01T00:00:00"},
    {
        ...
        "name": "National Strategy REDD+ for Equatorial Guinea", "postfix": "",
...
def test_original_bulk_import_state_s3():
    ...
    """
    s3_files = [path_.key for path_ in S3Path(f"s3://{PIPELINE_BUCKET}/").glob("*/*.json")]
